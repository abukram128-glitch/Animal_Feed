# ============================================================================
# تاور نولجي Tawornology العلمية - الإصدار المتكامل الشامل 14.0
# ============================================================================
...
# 1. PDF المختبر يعمل مع توقيع المشرف
# 2. صندوق وارد (Inbox) داخل المختبر لاستقبال العينات من تركيب العلف
# 3. زر واحد لتحليل العينة المرسلة دون إعادة إدخال المكونات
# 4. جميع التبويبات تعمل بكفاءة للمالك والمختصين والزائر
...
# =====================================================================
# قاعدة البيانات المتقدمة (SQLite) - مختصرة لتوفير المساحة
# =====================================================================
...
# =====================================================================
# مولد PDF المتقدم (مع توقيع المشرف)
# =====================================================================
class ProfessionalPDFGenerator:
    ...
    def generate_lab_report(self, analysis_results, animal_type, stage, user_name, 
        ...
        """توليد تقرير مختبر مع توقيع المشرف"""
        buffer = io.BytesIO()
...
if not st.session_state["approved"]:
    ...
    st.markdown("<p style='text-align:center; color:#888; font-size:0.9rem;'>الإصدار 14.0 - مع صندوق وارد المختبر</p>", unsafe_allow_html=True)
...
with tabs[0]:
    ...
    with animal_tabs[7]:
        ...
        if st.session_state.get("lab_sample"):
            ...
            # زر تحليل العينة المرسلة (زر واحد فقط)
