...
st.markdown(
    ...
    * {
        ...
        color: #1a1a1a !important;  /* غامق لكل النصوص */
    }
    ...
    /* تحسين ألوان الأزرار والنصوص التفاعلية */
    .stButton > button {
        color: #1a1a1a !important;
