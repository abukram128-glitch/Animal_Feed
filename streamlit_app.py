...
# حل مشكلة الالتفاف والقطع عبر حماية السطور بداخل مصفوفة مقسمة بعناية
css_lines = [
    '<style>',
    ...
    '.main-box { background-color: rgba(255, 255, 255, 0.98); padding: 30px;',
    ...
    '.section-title { color: #1b5e20; border-right: 6px solid #2e7d32; padding-right: 12px;',
    'text-align: right; font-size: 1.4rem; font-weight: bold; margin-top: 25px; margin-bottom: 15px; }',
    '.sack-tag { border: 3px dashed #1b5e20; padding: 25px; border-radius: 12px;',
    'background-color: #f1f8e9; direction: rtl; text-align: right; }',
    '.profile-img-style { width: 150px; height: 150px; border-radius: 50%; object-fit: cover;',
    'border: 4px solid #d4af37; box-shadow: 0px 6px 20px rgba(0,0,0,0.25); display: block; margin: 0 auto; }',
    '.animal-banner-img { width: 100%; max-height: 160px; object-fit: cover; border-radius: 8px;',
    'margin-bottom: 15px; border: 2px solid #2e7d32; }',
    '.mini-left-signature { position: fixed; left: 15px; bottom: 15px;',
    'background-color: rgba(27, 94, 32, 0.95); color: white; padding: 6px 15px;',
    'font-size: 0.8rem; border-radius: 20px; box-shadow: 0px 4px 10px rgba(0,0,0,0.2);',
    'z-index: 9999; direction: rtl; }',
    '.price-card { background: #f1f8e9; padding: 15px; border-radius: 8px;',
    'border-right: 5px solid #2e7d32; margin-bottom: 15px; direction: rtl; text-align: right; }',
    '.warning-card { background: #ffebee; padding: 12px; border-radius: 8px;',
    'border-right: 5px solid #c62828; margin-bottom: 10px; direction: rtl;',
